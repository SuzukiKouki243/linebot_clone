...
class LineBot extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.options.channelId = options.channelId || '1111';
    this.options.channelSecret = options.channelSecret || 'f53f33fc998f32375a3ba7fb9f2';
    this.options.channelAccessToken = options.channelAccessToken || 'tmKYNf+7bgTBG+AQqsTV7GCx9t1EyYslZwU1Bm1jSSGxOHHI5aM57XcGX2mMFgGKR3HL+aSOWIn1aTpiOhdRB/BVdzMcTydAc9G13430UAft4U21lBflUX2gdB04t89/1O/w1cDnyilFU=';
...
//          }
          ...
          console.log('**reach one ');
          return res.end('{}');
          console.log('**reach two ');
        });
      } else {
        res.statusCode = 404;
        res.setHeader('Content-Type', 'text/html; charset=utf-8');
